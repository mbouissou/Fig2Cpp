This directory contains an example of input and output files of Fig2Cpp.py, with their default names. The input files are renamed copies of the input files contained in input/Miniplant.

This example can be run by the simple command: python Fig2Cpp.py
