...
""")
    ...
    for att in all_attributes:
        ...
        if att.domain == "bool":
            ...
            nb_floatState += 1
            att.stateName = "doubleState[" + att.name + "]"
        elif att.domain == "int":
    ...
    cpp_header_file.write("\n//" + cur_indent + "std::vector<double> doubleState;")
    cpp_header_file.write("\n//" + cur_indent + "std::vector<double> backupDoubleState;")
    ...
    cpp_header_file.write(
        "\n" + cur_indent + "std::vector<std::tuple<int, double, std::string, int>> showFireableOccurrences();")
